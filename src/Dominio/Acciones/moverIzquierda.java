...
public class moverIzquierda extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        //Chequeo si estoy en la columna de más a la izquierda o hay un zombie, no puedo moverme. Devuelvo null
        if(posicion.getColumna() == 1 || estadoAgente.getPosicionTablero(posicion.getFila(),posicion.getColumna()-1) < 0)
            return null;
